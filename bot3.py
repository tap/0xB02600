"""Halite tournament bot, third generation: bot2 constants tuned by a 72-match sweep.
...
Run locally:
    uv run --script run-viewer.py bot3.py bot2.py random random
"""
...
CARGO_RETURN_THRESHOLD = 350   # bank sooner: less cargo exposed to hunters
...
HUNTERS_PER_PREY = 1           # lone chasers harass fine; packs waste a miner
